...
<div class="container mt-3 mb-3">
	<div class="row">
		<div class="col-md-12  animated fadeIn">
			<div class="card mb-2"><h4 class="font-weight-light navbar-text ml-3">Baptism Records</h4></div>
			
			<div class="card mb-5">
				<div class="card-body">
				
					<a href="form.php"><button class="btn btn-info mb-3"><i class="fa fa-plus"></i> New Baptism</button>	</a>
